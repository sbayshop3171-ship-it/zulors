...
class ProductRejectedNotification extends Notification implements ShouldQueue
{
    ...
    public $notificationType = Notifications::PRODUCT_REJECTED;
    ...
    {
        return (new MailMessage())->subject(__('notifications.subjects.product_rejected', locale: $notifiable->language))->view($this->notificationViewPath, [
