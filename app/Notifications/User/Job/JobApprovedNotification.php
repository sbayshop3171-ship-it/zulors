...
class JobApprovedNotification extends Notification implements ShouldQueue
{
    ...
    public $notificationType = Notifications::JOB_APPROVED;
    ...
    {
        return (new MailMessage())->subject(__('notifications.subjects.job_approved', locale: $notifiable->language))->view($this->notificationViewPath, [
