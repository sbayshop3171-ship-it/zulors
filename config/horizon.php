...
return [
    ...
    */
    ...
    'path' => env('HORIZON_PATH', 'zulorslab/horizon'),
    ...
    */
    ...
    'prefix' => env(
        'HORIZON_PREFIX',
        Str::slug(env('APP_NAME', 'zulors'), '_').'_horizon:'
    ),
    ...
    */
    ...
    'defaults' => [
        ...
        'supervisor-media-video' => [
            ...
            'maxTime' => 0,
            'maxJobs' => 0,
            'memory' => (int) env('MEDIA_VIDEO_MEMORY', 768),
            'tries' => 1,
        ...
        'supervisor-media-audio' => [
            'connection' => 'redis',
            'queue' => [env('MEDIA_AUDIO_QUEUE', 'media-audio')],
            'balance' => 'simple',
            'maxProcesses' => (int) env('MEDIA_AUDIO_MAX_PROCESSES', 1),
            'maxTime' => 0,
            'maxJobs' => 0,
            'memory' => (int) env('MEDIA_AUDIO_MEMORY', 256),
            'tries' => 1,
