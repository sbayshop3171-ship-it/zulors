    ...
    <div class="site-header__bar relative flex h-14 items-center justify-between px-4 md:px-8">
        ...
        <div class="site-header__actions inline-flex gap-5 text-lab-pr font-medium items-center ml-auto">
            <div x-data="{ isOpen: false }" x-on:click.away="isOpen = false" class="relative" x-cloak>
                ...
                <div x-show="isOpen" class="site-header__lang-menu absolute top-full right-0 rounded-md overflow-hidden min-w-60 ease-in-out transition-all shadow-md z-40">
