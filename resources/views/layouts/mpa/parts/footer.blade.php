...
<footer class="pb-4 pt-6 flex" style="min-width: 320px;">
    <div class="app-container mx-auto flex-1 px-4 md:px-8">
        <nav class="flex flex-wrap justify-center gap-2 md:gap-4 text-center">
        ...
        <div class="flex flex-col md:flex-row flex-wrap items-center justify-center gap-4 text-center">
            ...
            @if($showFooterAppBadges && (config('app.mobile_app_ios_link') || config('app.mobile_app_android_link')))
                <div class="flex md:inline-flex items-center justify-center gap-2">
