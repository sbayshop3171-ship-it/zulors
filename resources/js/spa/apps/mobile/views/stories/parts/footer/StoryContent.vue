<template>
	<div>
		<div v-if="storyMusic" class="mx-4 mb-2 inline-flex max-w-[calc(100%-2rem)] items-center gap-2 rounded-full bg-black/45 px-3 py-1.5 text-white backdrop-blur-md">
