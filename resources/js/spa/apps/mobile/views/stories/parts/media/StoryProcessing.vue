<template>
    <div class="h-full w-full overflow-hidden bg-black relative flex items-center justify-center">
        ...
        <div class="relative z-10 w-full max-w-[280px] px-8 text-center text-white">
            <div class="mx-auto mb-5 size-24 rounded-full border-2 bg-white/10 inline-flex-center" v-bind:class="isFailed ? 'border-red-500/70' : 'border-white/25'">
