<template>
    <div v-for="(mediaItem, idx) in postMedia" v-bind:key="mediaItem.id" class="overflow-hidden border border-bord-pr">
        <div class="flex items-center leading-none p-4" v-bind:class="{ 'opacity-50': mediaItem.deleted }">
