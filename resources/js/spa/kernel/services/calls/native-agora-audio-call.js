    ...
    const handleNativeEvent = (event) => {
        ...
        if(type === 'quality') {
            emit('onQualityStats', {
                ...
                available_outgoing_bitrate: detail.available_outgoing_bitrate,
                received_bitrate: detail.received_bitrate,
                tx_quality: detail.tx_quality,
                rx_quality: detail.rx_quality,
                network_transport_delay_ms: detail.network_transport_delay_ms,
                jitter_buffer_delay_ms: detail.jitter_buffer_delay_ms,
                end_to_end_delay_ms: detail.end_to_end_delay_ms,
                audio_device_delay_ms: detail.audio_device_delay_ms,
                audio_playout_delay_ms: detail.audio_playout_delay_ms,
                aec_estimated_delay_ms: detail.aec_estimated_delay_ms,
