...
5. Create an SMTP key from Brevo SMTP/API settings.
6. Verify a sender address such as `noreply@zulors.com`.

## Zulors Admin Settings
...
- That the password is the Brevo SMTP key, not the normal account password.
